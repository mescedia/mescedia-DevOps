...
--
-- Table structure for table `authFTPS`
--

DROP TABLE IF EXISTS `authFTPS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `authFTPS` (
...
--
-- Dumping data for table `authFTPS`
--

LOCK TABLES `authFTPS` WRITE;
/*!40000 ALTER TABLE `authFTPS` DISABLE KEYS */;
/*!40000 ALTER TABLE `authFTPS` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `authWebDAV`
--

DROP TABLE IF EXISTS `authWebDAV`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `authWebDAV` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `CompanyID` int(11) NOT NULL DEFAULT 0,
  `Name` varchar(30) NOT NULL,
  `Password` varchar(65) DEFAULT NULL,
...
--
-- Dumping data for table `authWebDAV`
--

LOCK TABLES `authWebDAV` WRITE;
/*!40000 ALTER TABLE `authWebDAV` DISABLE KEYS */;
/*!40000 ALTER TABLE `authWebDAV` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-07-01 11:28:52
